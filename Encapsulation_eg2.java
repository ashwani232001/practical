...
public static void main(String[] args) {//main method
	...
	b1.setAccount_num(63539);//setting value in the account number
	b1.setName("Ashwani");//setting value in the name
	b1.setE_mail("ash63539singh@gmail.com");//setting value in the e mail
